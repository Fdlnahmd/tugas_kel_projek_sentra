...
-------------------------------------------------- */
          ...
          <div class="carousel-item active">
            ...
            <div class="container">
              <div class="carousel-caption ccp ">
                ...
                <p><a class="btn btn-lg btn-primary" href="Menu User.php">See More</a></p>
              </div>
            </div>
          </div>
  ...
  ================================================== -->
      ...
      <div class="container marketing">
        ...
        <div class="border-2">
          <a class="menu" href="Menu User.php">
            <h1>Menu</h1>
          </a>
        </div>
        <br>
            ...
            <div class="collapse navbar-collapse" id="navbarsExample09">
              ...
              <div class="container ">
                <ul class="nav nav-fill text-uppercase justify-content-center">
                  <li class="nav-item dropdown"><a href="menu.php" class="nav-link "><br> Chicken</a></li>
                  <li class="nav-item dropdown"><a href="menu.php" class="nav-link "><br> Pork</a></li>
                  <li class="nav-item dropdown"><a href="menu.php" class="nav-link ">Tofu <br> & Omelette</a></li>
                  <li class="nav-item dropdown"><a href="menu.php" class="nav-link "><br> Fish</a></li>
                  <li class="nav-item dropdown"><a href="menu.php" class="nav-link "><br> Seafood</a></li>
                  <li class="nav-item dropdown"><a href="menu.php" class="nav-link "><br> Vegetables</a></li>
                  <li class="nav-item dropdown"><a href="menu.php" class="nav-link ">Soup,Rice, <br>& Noodles</a></li>
                  <li class="nav-item dropdown"><a href="menu.php" class="nav-link ">Desserts <br> & Beverages</a></li>
                </ul>
              </div>
            </div>
          </div>
