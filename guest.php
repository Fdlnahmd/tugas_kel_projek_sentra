...
<body>
    ...
    <nav class="nav py-2 border-bottom ">
      <div class="container d-flex flex-wrap">
        <ul class=" nav me-auto">
          <li class="nav-item dropdown"><a href="#bck" class="nav-link ">Home</a></li>
          <li class="nav-item dropdown"><a href="#about-us" class="nav-link ">About Us</a></li>
          <li class="nav-item dropdown"><a href="#menu" class="nav-link ">Menu</a></li>
          <li class="nav-item dropdown"><a href="#franchise" class="nav-link ">Franchise</a></li>
        ...
        <ul class="nav">
          <li class="nav-item dropdown"><a href="Login.php" class="nav-link px-2">Login</a></li>
          <li class="nav-item dropdown"><a href="Sign Up.php" class="nav-link px-2">Sign Up</a></li>
          &emsp;
        </ul>
      </div>
    </nav>
        ...
        <div class="carousel-item active">
          ...
          <div class="container">
            <div class="carousel-caption ccp ">
              ...
              <p><a class="btn btn-lg btn-primary" href="menu.php#chicken">See More</a></p>
            </div>
          </div>
        </div>
        <div class="carousel-item">
          ...
          <div class="container">
            <div class="carousel-caption ccp ">
              ...
              <p><a class="btn btn-lg btn-primary" href="menu.php#pork">See More</a></p>
            </div>
          </div>
        </div>
        <div class="carousel-item">
          ...
          <div class="container">
            <div class="carousel-caption ccp ">
              ...
              <p><a class="btn btn-lg btn-primary" href="menu.php#seafood">See More</a></p>
            </div>
          </div>
        </div>
      </div>
  ...
  ================================================== -->
    ...
    <div class="container marketing">
      ...
      <div class="border-2">
        <a class="menu" href="Menu Guest.php">
          <h1>Menu</h1>
        </a>
      </div>
      <br>
          ...
          <div class="collapse navbar-collapse" id="navbarsExample09">
            ...
            <div class="container ">
              <ul class="nav nav-fill text-uppercase justify-content-center">
                <li class="nav-item dropdown"><a href="menu.php#chicken" class="nav-link "><br> Chicken</a></li>
                <li class="nav-item dropdown"><a href="menu.php#pork" class="nav-link "><br> Pork</a></li>
                <li class="nav-item dropdown"><a href="menu.php#omelette" class="nav-link ">Tofu <br> & Omelette</a></li>
                <li class="nav-item dropdown"><a href="menu.php#fish" class="nav-link "><br> Fish</a></li>
                <li class="nav-item dropdown"><a href="menu.php#seafood" class="nav-link "><br> Seafood</a></li>
                <li class="nav-item dropdown"><a href="menu.php#vegetables" class="nav-link "><br> Vegetables</a></li>
                <li class="nav-item dropdown"><a href="menu.php#srn" class="nav-link ">Soup,Rice, <br>& Noodles</a></li>
                <li class="nav-item dropdown"><a href="menu.php#dnb" class="nav-link ">Desserts <br> & Beverages</a></li>
              </ul>
            </div>
          </div>
        </div>
